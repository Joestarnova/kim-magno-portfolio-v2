...
export default function SkillsSection({ skills }: SkillsSectionProps) {
  return (
    <section id="skills" className="km-section-spacer" style={css('margin-top:210px;scroll-margin-top:110px')}>
      ...
      <div className="km-skills-grid" style={css('display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px;max-width:1000px;margin:0 auto')}>
        {skills.map((group) => (
